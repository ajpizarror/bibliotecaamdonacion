...
public class SwaggerConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
                .info(new Info()
                        .title("API 2026 Sistema de donaciones hechos a la Biblioteca AM")
                        .version("1.0")
                        .description("Gestion y registro de personas que han donado o realizado contribuciones a la Biblioteca AM"))
                .servers(List.of(
                        new Server()
                                .url(serverUrl)
