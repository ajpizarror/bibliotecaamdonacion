...
public class DonacionController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Donaciones no encontradas")
    })
    ...
    @Operation(summary = "Obtener donacion por apellido", description = "Obtiene una donacion acorde a un apellido.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Operación exitosa"),
            @ApiResponse(responseCode = "404", description = "Donacion no encontrada")
    })
